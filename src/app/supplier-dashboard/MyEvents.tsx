...
const MyEvents: React.FC = () => {
  ...
  const currentEvents = events.filter(event => !event.isPastEvent);
  ...
  return (
    <div>
      ...
      {currentEvents.length === 0 ? (
        <div className="bg-white rounded-lg shadow-lg p-8 text-center text-gray-500">No current events.</div>
      ) : (
      ...
      {pastEvents.length === 0 ? (
        <div className="bg-white rounded-lg shadow-lg p-8 text-center text-gray-500">No past events.</div>
      ) : (
