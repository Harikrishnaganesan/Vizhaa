...
export default function ContactInfo() {
  return (
    <div className="bg-[#23364E] text-white p-6 sm:p-8 rounded-xl">
      <h2 className="text-xl sm:text-2xl font-bold mb-6">Get in Touch</h2>
      <div className="space-y-6">
        <div className="flex items-start gap-4">
          <div className="bg-[#2DBE60] p-3 rounded-lg flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm sm:text-base">Coimbatore, Tamil Nadu, India</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm sm:text-base break-all">contact@vizhaa.com</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm sm:text-base">Mon - Fri: 9:00 AM - 6:00 PM</p>
            <p className="text-gray-300 text-sm sm:text-base">Sat: 10:00 AM - 4:00 PM</p>
          </div>
        </div>
      </div>
    </div>
